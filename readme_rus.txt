...
Список валютных пар для мониторинга программа берёт из файла CURRENCY.TXT, наличие которого обязательно в папке с программой.
...
Для наглядности контроля прибыльности торговли, количество валютных пар, количество BUY-SELL сделок, суммарный профит и текущая суммарная стоимость 
ВСЕХ приобретённых активов, включая свободные средства баланса, отображается в шапке с названием окна бота и сохраняются в файле ACTIVE.txt
